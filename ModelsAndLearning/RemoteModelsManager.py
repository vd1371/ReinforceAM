...
class RemoteModelsManager:
	...
	def predict_actions_for_all(self, S, eps = 0):
		A = predict_actions_for_all_remote(self.ports, S, eps)
		return A

	def predict_critic_values_for_all(self, S_hist):
		critics = predict_critics_remote(self.ports, S_hist)
		return critics

	def partial_fit_A2C(self, *args, **kwargs):
		partial_fit_remote_A2C(self.ports, *args, **kwargs)
	...
	def save_all(self):
		n_trained = save_all_remote_models(self.ports)
		return n_trained
