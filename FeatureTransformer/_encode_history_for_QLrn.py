...
from ._evaluate_Q_for_double_Q_learning import _evaluate_Q_for_double_Q_learning
from ._evaluate_Q_for_vanilla_Q_learning import _evaluate_Q_for_vanilla_Q_learning
		...
		for id_ in nextS_hist:
			...
			for step in range(LrnObjs.settings.n_steps):
				...
				if step == LrnObjs.settings.n_steps - 1:
					...
					target, maxQ_values = \
							LrnObjs.models[id_].predict_Q_values(S_at_step)
					
					if LrnObjs.is_double:
						Q = _evaluate_Q_for_double_Q_learning(id_, nextS_at_step, LrnObjs)
